...
<section class="what-we-look-for">
	<div class="container">
		...
		<div class="section-title blokk-section-title-a">
			<!-- Title -->
			<h2 class="title"><?php echo meta_get_option('what_we_look_for_investor_title'); ?></h2><!-- // Title -->
		</div><!-- // Section Title -->

		<!-- Section Description -->
		<div class="section-description blokk-section-description-a">
			<p><?php echo meta_get_option('what_we_look_for_investor_description'); ?></p>
		...
		<div class="blokk-feature-blocks-a">
			...
			<?php
				$what_we_look_for_investor_widgets = meta_get_option('what_we_look_for_investor_widgets');
				// echo '<pre>';
				// print_r($what_we_look_for_investor_widgets);
				// echo '</pre>';
				foreach ($what_we_look_for_investor_widgets as $widgets => $block) {
			?>
