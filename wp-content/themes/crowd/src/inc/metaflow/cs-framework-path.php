 ...
 *
 */
if ( ! function_exists( 'meta_get_option' ) ) {
  function meta_get_option( $option_name = '', $default = '' ) {

    $options = apply_filters( 'meta_get_option', get_option( CS_OPTION ), $option_name, $default );
 ...
 *
 */
if ( ! function_exists( 'meta_set_option' ) ) {
  function meta_set_option( $option_name = '', $new_value = '' ) {

    $options = apply_filters( 'meta_set_option', get_option( CS_OPTION ), $option_name, $new_value );
