...
abstract class CSFramework_Options extends CSFramework_Abstract {
  ...
  public function element_addon() {
    return ( isset( $this->field['addon'] ) ) ? '<span style="width:30px;text-align:center;padding:3px 7px 2px;font-size:11px;background:#f1f1f1;border:1px solid #ddd;display:inline-block;position:relative;top:-1px;left:-2px;border-top-right-radius:3px;border-bottom-right-radius:3px;">'.$this->field['addon'].'</span>' : '';
  }
